...
// Brand
errorHelper.ERROR_INVALID_BRAND = { code: 'ERROR_INVALID_BRAND', message: "Brand is invalid" };
errorHelper.ERROR_INVALID_BRAND_KEY = { code: 'ERROR_INVALID_BRAND_KEY', message: "Brand Key is invalid" };

errorHelper.ERROR_NOT_EXIST_BRAND_KEY = { code: 'ERROR_NOT_EXIST_BRAND_KEY', message: 'Brand Key does not existed.' };
